  ...
  const sections = [
    {
      title: "OVERVIEW",
      content: [
        "This website is operated by Rosh Fine Jewellery. Throughout the site, the terms \"we\", \"us\" and \"our\" refer to Rosh Fine Jewellery. Rosh Fine Jewellery offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.",
    ...
    },
    {
      ...
      content: [
        ...
        "By buying a product from Rosh Fine Jewellery you agree to give permission to Rosh Fine Jewellery for using your photo/video content where you're using a Rosh Fine Jewellery product, for re-sharing on Rosh Fine Jewellery's social and promotional handles as stories, posts, reels or ad content or for use on website, without asking for your written permission."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "In no case shall Rosh Fine Jewellery, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law."
      ]
    },
    {
      title: "SECTION 14 - INDEMNIFICATION",
      content: [
        "You agree to indemnify, defend and hold harmless Rosh Fine Jewellery and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        "Questions about the Terms of Service should be sent to us at concierge@rosh.com."
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-[#EBE5DE] text-rosh-primary font-sans flex flex-col">
      <div className="flex-1 max-w-[1000px] w-full mx-auto px-6 md:px-12 py-20 md:py-32">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif italic mb-8">Terms of Service</h1>
